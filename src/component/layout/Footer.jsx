  ...
  return (
    <footer className="bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white py-10">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg font-medium mb-2">&copy; 2024 BazaarPrice BD. সকল অধিকার সংরক্ষিত।</p>
        <p className="text-gray-400 mb-6">আপনার বাজারের সাথী - info@bazaarpricebd.com</p>
