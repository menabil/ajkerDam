...
const About = () => {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-4xl font-bold mb-6">আজকের দাম সম্পর্কে</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-2xl font-semibold mb-4">আমাদের গল্প</h2>
          <p className="text-gray-600 mb-4">
            ২০১৪ সালে প্রতিষ্ঠিত আজকের দাম একটি সাধারণ ধারণা থেকে শুরু হয়: সঠিক বাজার দর প্রদর্শন এবং সবাইকে বাজার কেনাকাটা সহজ করে দেয়া। যে পরিষেবা শুরুতে কেবল দামের ট্র্যাকিং করতো, আজ তা বাংলাদেশের সবচেয়ে বিশ্বস্ত বাজার দর তথ্য প্ল্যাটformে পরিণত হয়েছে।
          </p>
