    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-2xl font-semibold mb-4">আজকের দাম সম্পর্কে</h2>
          <p className="text-gray-600 mb-4">
            আজকের দামে স্বাগতম! আমরা বাংলাদেশের দৈনিক বাজারজাত দ্রব্যের সঠিক ও নবীনতম বাজার দর প্রদান করি। ১০ বছরেরও বেশি অভিজ্ঞতা নিয়ে আমরা গ্রাহকদের নির্ভরযোগ্য মূল্য তথ্য দিয়ে সচেতন কেনাকাটায় সাহায্য করতে প্রতিশ্রুতিবদ্ধ।
          </p>
          <p className="text-gray-600 mb-4">
